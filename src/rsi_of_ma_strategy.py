...
def compute_indicators(
    ...
    """Add columns: ma, rsi_ma, rsi_signal, robust_long, robust_short."""
    df = df.copy()
...
def generate_trades(
    ...
    """Build a trade list from robust_long / robust_short signals.

    Assumptions:
      - Signal on day T
      - Enter at next day open (T+1)
      - Exit same day close (T+1)
    """
